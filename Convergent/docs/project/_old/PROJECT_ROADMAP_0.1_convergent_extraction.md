# PROJECT ROADMAP
#### Description: Strategic roadmap for the convergent governance extraction project. Defines phases, milestones, and the path from embedded governance to standalone versioned system.
#### Convergent: v1.3.2
#### File version: 0.1
...
| Folder Structure | `docs/dev/foundation/FOLDER_STRUCTURE.md` | v0.3 |
...
└── convergent/                                 # GVS umbrella project
    ...
    └── gvs_development/                        # CLIENT — governance development project
        └── version1.4/                         # Work product: the next governance version
            ...
            │   │   ├── INDEX_SPRINTS.md
            │   │   ├── files/
            │   │   │   ├── backlog/            #   AF item files
            │   │   │   ├── bugs/               #   BUG report files
            │   │   │   ├── decisions/          #   ADR files
            │   │   │   └── sprints/            #   Sprint folders (S##/)
            │   │   │       └── S##/
            │   │   │           ├── S##_DESCRIPTION.md
            │   │   │           ├── S##_REVIEW.md
            │   │   │           └── artifacts/
            ...
            │   │       ├── PROJECT_ROADMAP.md
            │   │       └── prompts/
            │   └── foundation/                 #   Updated governance docs + centralized templates
            ...
            │           ├── FOLDER_STRUCTURE.md
            │           ├── LIFECYCLE_REGISTRY.md
            │           └── SESSION_CHAIN.md
            │
            └── user/                           # DEVELOPMENT ARTIFACTS (GVS's own sprints)
                ├── additional/                 #   Observations, plans, free-form docs
                ├── docs/
                │   ├── INDEX_BACKLOG.md         #   GVS's own INDEX files
                │   ├── INDEX_BUGS.md
                │   ├── INDEX_DECISIONS.md
                │   ├── INDEX_SPRINTS.md
                │   ├── files/
                │   │   ├── backlog/            #   GVS's own AF items
                │   │   ├── bugs/               #   GVS's own BUG reports
                │   │   ├── decisions/          #   GVS's own ADR files
                │   │   └── sprints/            #   GVS's own sprint folders
                │   └── project/
