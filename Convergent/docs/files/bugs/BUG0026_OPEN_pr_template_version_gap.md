# BUG REPORT — BUG0026 — pr_template_version_gap
# Version number: v1.3
...
- **Date:** 2026-04-05
- **Related backlog item(s):** AF-0136
- **Related PR(s):** —

---

## Summary
`PULL_REQUEST_TEMPLATE.md` was not bumped to v1.3 during the GSV v1.3 rollout in AF-0136. All other governance INDEX files (4) and templates (5) were updated, but this template remains at v0.2.
