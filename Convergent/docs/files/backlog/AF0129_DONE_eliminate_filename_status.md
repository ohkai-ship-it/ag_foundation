...
# Version number: v0.2
# Created: 2026-04-04
# Started: 2026-04-05T10:00:00+02:00
# Completed: 2026-04-05T10:30:00+02:00
# Status: DONE
# Priority: P0
# Area: Process / Docs
...
## Acceptance Criteria
- [x] New AF/BUG files created after this AF do NOT contain status tokens in filename
- [x] Existing files remain untouched (old-convention names preserved)
- [x] All INDEX links resolve to existing files (both old and new convention)
- [x] `pytest tests/test_documentation_drift.py -W error` passes
- [x] SPRINT_MANUAL updated: §2.2 (new convention), §2.3 (no rename for new files), §7.1 (no rename step), §8.4 (mismatch scan legacy-only)
- [x] FOLDER_STRUCTURE updated to document both conventions (legacy + new)
...
- **Rationale:** SPRINT_MANUAL §2.2, §2.3, §7.1, §8.4 updated. FOLDER_STRUCTURE_0.2 documents both conventions. test_documentation_drift.py passes (10/10). No test changes needed — existing tests don't enforce filename patterns.
- **Follow-ups:** None
