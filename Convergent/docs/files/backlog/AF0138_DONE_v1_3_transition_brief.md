...
- **Phase:** 7.5 (after AF-0134, before AF-0136)
...
This pattern has already been observed during Sprint 16 implementation.
...
- Changing the v1.3 conventions themselves (that's AF-0129 through AF-0134)
- Documenting the full governance system (that's AF-0136)
...
After the new naming convention documentation (which AF-0129/AF-0136 will add). One line:
