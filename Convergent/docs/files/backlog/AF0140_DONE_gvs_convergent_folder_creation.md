# BACKLOG ITEM — AF0140 — gvs_convergent_folder_creation
# Version number: v1.3
# Created: 2026-04-05
# Started: 2026-04-05
...
Create the `convergent/` folder structure and populate `gvs_version_fixed/version1.3/` with a copy of ag_foundation's `docs/dev/` tree. This is the manual human prerequisite that enables AF-0139.
...
- Do NOT populate files inside `gvs_development/` — that's AF-0139
- Do NOT write copilot instructions — that's AF-0139
