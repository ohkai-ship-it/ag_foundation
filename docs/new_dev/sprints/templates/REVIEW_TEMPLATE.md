...
> **Location:** `/docs/new_dev/sprints/documentation/Sprint##_three_word_description/S##_REVIEW_01.md`
...
- `/docs/new_dev/sprints/documentation/Sprint##_three_word_description/artifacts/review_S##_01/`
...
- [ ] Create bug reports in `/docs/new_dev/bugs/reports/` using template
