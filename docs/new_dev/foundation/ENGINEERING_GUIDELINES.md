...
This document is the **single source of truth** for engineering execution in ag_foundation under `/docs/new_dev/`.

## Canonical references
- Coding: `/docs/new_dev/foundation/CODING_GUIDELINES.md`
- Testing: `/docs/new_dev/foundation/TESTING_GUIDELINES.md`
- Repo hygiene: `/docs/new_dev/foundation/REPO_HYGIENE.md`
...
- Backlog items: `/docs/new_dev/backlog/items/`
- Bugs: `/docs/new_dev/bugs/reports/`
- ADRs: `/docs/new_dev/decisions/files/`
- Sprint documentation: `/docs/new_dev/sprints/documentation/Sprint##_.../`
