...
It is canonical for `/docs/new_dev`.

## Artifacts and where they live
- Backlog index: `/docs/new_dev/backlog/INDEX_BACKLOG.md`
- Bugs index: `/docs/new_dev/bugs/INDEX_BUGS.md`
- Decisions index: `/docs/new_dev/decisions/INDEX_DECISIONS.md`
- Sprints index: `/docs/new_dev/sprints/INDEX_SPRINTS.md`

## Naming conventions (strict)
### Backlog items
- File name: `AF####_<Status>_<three_word_description>.md`
- Status: `Proposed | Ready | In progress | Blocked | Done | Dropped`
- Location: `/docs/new_dev/backlog/items/`

### Bug reports
- File name: `BUG####_<Status>_<three_word_description>.md`
- Status: `Open | In progress | Fixed | Verified | Dropped`
- Location: `/docs/new_dev/bugs/reports/`

### ADRs
- File name: `ADR###_<three_word_description>.md`
- Status inside file: `Proposed | Accepted | Superseded | Deprecated`
- Location: `/docs/new_dev/decisions/files/`

### Sprints
- Folder: `/docs/new_dev/sprints/documentation/Sprint##_three_word_description/`
- Files:
