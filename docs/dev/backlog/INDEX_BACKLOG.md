...
| AF-0058 | P1 | Ready | Workspace folder restructure | Storage | Jacob | `/docs/dev/backlog/items/AF0058_Ready_workspace_folder_restructure.md` |
...
| AF-0053 | P0 | Done | Provider test stability | Testing | Jacob | `/docs/dev/backlog/items/AF0053_Done_provider_test_stability.md` |
| AF-0054 | P1 | Done | Citation model unification | Core | Jacob | `/docs/dev/backlog/items/AF0054_Done_citation_model_unification.md` |
| AF-0055 | P1 | Done | Verifier loop bounding | Verifier | Jacob | `/docs/dev/backlog/items/AF0055_Done_verifier_loop_bounding.md` |
