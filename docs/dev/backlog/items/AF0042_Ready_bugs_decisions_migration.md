...
## Goal
Create canonical bugs and decisions systems in `/docs/new_dev/bugs` and `/docs/new_dev/decisions` with strict filenames, updated templates, and renamed indexes.
...
- `docs/new_dev/bugs/templates/BUG_REPORT_TEMPLATE.md`
- `docs/new_dev/bugs/reports/BUG0001_Fixed_global_options_not.md`
- `docs/new_dev/bugs/reports/BUG0002_Open_missing_run_options.md`
- `docs/new_dev/bugs/reports/BUG0003_Open_missing_cli_subcommands.md`
- `docs/new_dev/bugs/reports/BUG0004_Fixed_sqlite_connection_leak.md`
- `docs/new_dev/bugs/reports/BUG0005_Fixed_implicit_workspace_creation.md`
- `docs/new_dev/bugs/reports/BUG0006_Fixed_title_slug_tbd.md`
- `docs/new_dev/decisions/INDEX_DECISIONS.md`
- `docs/new_dev/decisions/templates/ADR_TEMPLATE.md`
- `docs/new_dev/decisions/files/ADR001_architecture_baseline_tbd.md`
- `docs/new_dev/decisions/files/ADR002_trace_versioning_tbd.md`
- `docs/new_dev/decisions/files/ADR003_manual_mode_gating.md`
- `docs/new_dev/decisions/files/ADR004_storage_baseline_tbd.md`
- `docs/new_dev/decisions/files/ADR005_orchestrator_threshold_tbd.md`

## Acceptance criteria (Definition of Done)
- [ ] All bug reports exist in `/docs/new_dev/bugs/reports/` using the new BUG filename template
- [ ] All ADR files exist in `/docs/new_dev/decisions/files/` using the new ADR filename template
