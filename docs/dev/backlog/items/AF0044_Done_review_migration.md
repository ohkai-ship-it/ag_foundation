...
### Canonical (`/docs/dev/`)
- `docs/dev/sprints/templates/REVIEW_TEMPLATE.md (canonical)`
- `docs/dev/sprints/documentation/Sprint04_process_hardening/S04_REVIEW_01.md (first use)`
- `docs/dev/sprints/documentation/Sprint04_process_hardening/artifacts/review_evidence/ (folder; canonical evidence location)`
- `docs/dev/sprints/INDEX_SPRINTS.md (links to review files)`

## Acceptance criteria (Definition of Done)
- [ ] Canonical review template exists in `/docs/dev/sprints/templates/REVIEW_TEMPLATE.md` and is used for Sprint04 review
