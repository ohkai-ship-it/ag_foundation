# BACKLOG ITEM --- AF0048 --- Structured brief skill
...
Implement strategic_brief skill that reads workspace markdown files and
produces structured JSON + markdown artifact outputs.
