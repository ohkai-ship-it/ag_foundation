...
## Goal
Introduce per-sprint documentation folders under `/docs/new_dev/sprints/documentation/`, merge sprint and review templates, and deprecate `SPRINT_LOG.md` in favor of `INDEX_SPRINTS.md` + per-sprint folders.
...
- `docs/new_dev/sprints/documentation/Sprint04_process_hardening/artifacts/ (folder)`
- `docs/new_dev/sprints/INDEX_SPRINTS.md`
- `docs/new_dev/sprints/templates/SPRINT_DESCRIPTION_TEMPLATE.md`
- `docs/new_dev/sprints/templates/REVIEW_TEMPLATE.md`
- `docs/new_dev/sprints/templates/PULL_REQUEST_TEMPLATE.md (path stays; links updated)`

## Acceptance criteria (Definition of Done)
- [ ] `docs/new_dev/sprints/templates/SPRINT_DESCRIPTION_TEMPLATE.md` exists (plan + report combined)
- [ ] `docs/new_dev/sprints/templates/REVIEW_TEMPLATE.md` exists (tasks + entry combined)
- [ ] `docs/new_dev/sprints/INDEX_SPRINTS.md` exists and links to each sprint folder
- [ ] New sprint folder exists for Sprint04 and contains S04_DESCRIPTION / S04_REVIEW_01 / S04_PR_01


## Implementation notes
Copy legacy sprint docs to /docs/new_dev/sprints/documentation/old.
