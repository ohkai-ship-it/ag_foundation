...
## Goal
Create a single canonical backlog system in `/docs/new_dev/backlog/` where each AF file contains both the item definition and its completion section, with strict filename conventions and a renamed INDEX_BACKLOG.
...
- `docs/dev/backlog/templates/BACKLOG_ITEM_TEMPLATE.md` + `docs/dev/backlog/templates/COMPLETION_NOTE_TEMPLATE.md`
  → `docs/new_dev/backlog/templates/BACKLOG_ITEM_TEMPLATE.md` (includes “Completion” section)
...
- `docs/new_dev/backlog/templates/BACKLOG_ITEM_TEMPLATE.md`
- `docs/new_dev/backlog/items/AF0001_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0002_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0003_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0004_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0005_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0006_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0007_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0008_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0009_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0010_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0011_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0012_Ready_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0013_Ready_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0014_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0015_Ready_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0016_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0017_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0018_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0019_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0021_Done_storage_lifecycle_hardening.md`
- `docs/new_dev/backlog/items/AF0022_Done_provider_coverage_hardening.md`
- `docs/new_dev/backlog/items/AF0023_Done_environment_configuration_hardening.md`
- `docs/new_dev/backlog/items/AF0024_Done_workspace_lifecycle_correction.md`
- `docs/new_dev/backlog/items/AF0025_Done_test_discipline_enforcement.md`
- `docs/new_dev/backlog/items/AF0026_Done_workspace_selection_policy.md`
- `docs/new_dev/backlog/items/AF0027_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0028_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0029_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0030_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0031_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0032_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0033_Done_title_slug_tbd.md`
- `docs/new_dev/backlog/items/AF0034_Ready_workspace_error_hardening.md`
- `docs/new_dev/backlog/items/AF0035_Ready_clarify_workspace_flag.md`
- `docs/new_dev/backlog/items/AF0036_Ready_remove_global_cli.md`
- `docs/new_dev/backlog/items/AF0037_Ready_standardize_workspace_errors.md`
- `docs/new_dev/backlog/items/AF0038_Ready_json_error_path.md`

## Acceptance criteria (Definition of Done)
- [ ] `docs/new_dev/backlog/templates/BACKLOG_ITEM_TEMPLATE.md` exists and includes the Completion section
- [ ] All AF items from `/docs/dev/backlog/items/` are migrated into `/docs/new_dev/backlog/items/` with the new filename convention
...
- [ ] `docs/new_dev/backlog/INDEX_BACKLOG.md` exists and links to the canonical AF files
...
## PR plan (PR-sized)
1. PR: Create merged BACKLOG_ITEM_TEMPLATE in `/docs/new_dev/backlog/templates/`
