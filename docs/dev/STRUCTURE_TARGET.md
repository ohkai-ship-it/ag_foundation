# docs/new_dev/ — Directory Structure
...
│   │       BUG-0002-trace-show-missing-skill.md
│   │       BUG-0003-trace-show-missing-trace.md
│   │       BUG-0004-run-id-padding-conflict.md
│   │       BUG-0005-empty-sqlite-queries.md
│   │       BUG-0006-delegation-invoke-missing.md
│   └───templates/
