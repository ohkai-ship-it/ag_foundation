...
> **⚠️ DEPRECATED (2026-03-03):** This index is archived. The canonical bug tracker is now at `/docs/new_dev/bugs/INDEX_BUGS.md`. Bug files have been migrated with the new naming convention.
