...
| ID | Severity | Status | Title | Area | New file (target path) |
|---:|:--:|:--|---|---|---|
| BUG-0009 | P0 | Fixed | Direct skill skips verifier | CLI/Core/Verifier | `/docs/dev/bugs/reports/BUG0009_Fixed_direct_skill_skips_verifier.md` |
| BUG-0010 | P0 | Fixed | Skill trace missing artifacts evidence | Core/Recorder/Skills | `/docs/dev/bugs/reports/BUG0010_Fixed_skill_trace_missing_artifacts.md` |
