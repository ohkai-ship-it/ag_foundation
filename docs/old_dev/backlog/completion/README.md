...
> **⚠️ DEPRECATED (2026-03-03):** This folder is archived. Completion notes are now embedded directly in AF item files under `/docs/dev/backlog/items/`. See [INDEX_BACKLOG](/docs/dev/backlog/INDEX_BACKLOG.md) for the canonical location.
