...
# Version number: v0.2
# Created: 2026-04-04
# Started: 2026-04-05T11:30:00+02:00
# Completed: 2026-04-05T12:00:00+02:00
# Status: DONE
# Priority: P1
...
## Acceptance Criteria
- [x] FOUNDATION_MANUAL contains a dedicated HITL Framework section
- [x] All 15 mandatory gates documented (G1–G15) in a numbered table with trigger condition
- [x] Escalation procedure documented (document → propose options → recommend → wait)
- [x] All four human rights documented (can override, can scope-reduce, can defer, can cancel)
- [x] Constitutional principle stated: *"A chat instruction is a temporary amendment to the current session. It does not change the documented governance. To make a permanent change, open an AF."*
- [x] Review decision table with all three outcomes and consequences
- [x] Quickfix budget rule: ≤30 min cumulative per sprint review, human-overridable
- [x] SPRINT_MANUAL references HITL Framework section at each relevant decision point
...
- **Rationale:** FOUNDATION_MANUAL §10 added with full HITL framework: 15 gates (G1–G15) in table, escalation procedure, 4 human rights, constitutional principle, review decisions table, quickfix budget rule. SPRINT_MANUAL header references HITL section.
- **Follow-ups:** None
